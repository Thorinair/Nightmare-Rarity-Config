...
//#define POINT_SPACING 25.3 // (Bed Size - 50 - Back Edge) / (Point Count - 4)

#if EITHER(MESH_BED_LEVELING, AUTO_BED_LEVELING_UBL)
  // Override the mesh area if the automatic (max) area is too large
  #define MESH_MIN_X MESH_INSET
  #define MESH_MAX_X X_BED_SIZE - (MESH_INSET)
  //#define MESH_MIN_Y MIN_PROBE_EDGE_FRONT + 50 - POINT_SPACING*2
  //#define MESH_MAX_Y Y_BED_SIZE - MIN_PROBE_EDGE_BACK + POINT_SPACING
...
#define ARC_SUPPORT                 // Disable this feature to save ~3226 bytes
  ...
  #define MIN_ARC_SEGMENTS       64 // Minimum number of segments in a complete circle
  //#define ARC_SEGMENTS_PER_SEC 50 // Use feedrate to choose segment length (with MM_PER_ARC_SEGMENT as the minimum)
  #define N_ARC_CORRECTION       24 // Number of interpolated segments between corrections
